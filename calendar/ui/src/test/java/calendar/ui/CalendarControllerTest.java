...
// assertNotNull(controller.startTimeSpinner.getValueFactory(), "Start
// timespinner should be initialized.");
// assertNotNull(controller.endTimeSpinner.getValueFactory(), "End time spinner
// should be initialized.");
// assertEquals(8, controller.startTimeSpinner.getValueFactory().getValue(),
// "Start time should default to 8.");
// assertEquals(12, controller.endTimeSpinner.getValueFactory().getValue(),
// "Endtime should default to 12.");
...
// assertEquals(initialDate.minusWeeks(1), controller.weekDate, "The weekDate
// should be one week earlier.");
// assertEquals("previousWeek pressed", controller.messageLabel.getText(),
// "Message label should be updated.");
// }
...
// assertEquals(initialDate.plusWeeks(1), controller.weekDate, "The weekDate
// should be one week later.");
// assertEquals("nextWeek pressed", controller.messageLabel.getText(),
// "Messagelabel should be updated.");
...
// // assertTrue(children.get(0) instanceof VBox, "Added node should be a
// VBox.");
// // VBox eventBox = (VBox) children.get(0);
// // assertTrue(eventBox.getChildren().get(0) instanceof Label, "VBox should
// // contain a Label.");
// // assertEquals("Test Event", ((Label)
// eventBox.getChildren().get(0)).getText(),
