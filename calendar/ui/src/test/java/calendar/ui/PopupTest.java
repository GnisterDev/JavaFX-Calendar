...
public class PopupTest extends ApplicationTest {
        ...
        public void start(Stage stage) throws Exception {
                ...
                try (
                        ...
                        mockedRestHelper.when(() -> RestHelper
                                        .editEvent(ArgumentMatchers.any(),
                        ...
                        mockedRestHelper.when(() -> RestHelper
                                        .removeEvent(ArgumentMatchers.any()))
                                        .thenReturn(VoidResult.success());
                        ...
                        popupController.initialize(mockEvent,
        ...
        public void setUp() {
                ...
                eventNameField = lookup("#eventNameField")
                                .queryAs(TextField.class);
                startDateSelect = lookup("#startDateSelect")
                                .queryAs(DatePicker.class);
                endDateSelect = lookup("#endDateSelect")
                                .queryAs(DatePicker.class);
                startTimeSelect = lookup("#startTimeSelect")
                                .queryAs(TextField.class);
                endTimeSelect = lookup("#endTimeSelect")
                                .queryAs(TextField.class);
        ...
        public void testInitializeListeners() {
                ...
                Platform.runLater(() -> startDateSelect
        ...
        public void testTimeSelectLoseFocus() {
                ...
                verify(mockCalendarController)
                                .timeSelectLoseFocus(startTimeSelect);
                ...
                verify(mockCalendarController)
                                .timeSelectLoseFocus(endTimeSelect);
        }
