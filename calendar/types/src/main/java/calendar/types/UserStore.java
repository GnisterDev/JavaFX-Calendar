...
/**
 * UserStore manages a mapping between usernames and user IDs, as well as a mapping between user IDs and {@link User} objects.
 * It provides methods for adding, removing, and checking the existence of users by their username or user ID.
 */
public class UserStore {
    ...
    /**
    * Constructs a new {@code UserStore} with the provided mappings of usernames to user IDs and user IDs to users.
    *
    * @param usernameToUserId a {@code Map} of usernames to their corresponding user IDs
    ...
    */
     ...
     * @return {@code true} if the user was added, {@code false} if the user already exists
     */
     ...
     * @return {@code true} if the user was removed, {@code false} if the user does not exist
     */
     ...
     * @return {@code true} if the user ID exists, {@code false} otherwise
     */
     ...
     * @return an {@code Optional} containing the user ID if found, or an empty {@code Optional} if not found
     */
     ...
     * @return an {@code Optional} containing the {@link User} if found, or an empty {@code Optional} if not found
     */
