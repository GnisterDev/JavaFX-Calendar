 ...
 * specific user within their calendars.
 * It allows users to add, remove, and query events, as well as create new
...
public class CalendarApp {
     ...
     * @return a {@link List} of {@link Event} objects occurring between the
     *         specified times
     */
